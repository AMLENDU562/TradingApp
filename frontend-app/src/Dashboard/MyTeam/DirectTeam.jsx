...
export default function DirectTeam() {
    ...
    const columns = [
        'ID','Name','Amount','Commision','UserId'];
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        try {
          const response = await fetch(`http://localhost:8080/api/directTeam/all/602`, {
            method: 'GET',
            headers: {
  ...
  return (
    <div style={{backgroundColor:"white",width:"70%",margin:"20px auto",padding:"20px"}}>
        ...
        <h3 style={{textAlign:"left",paddingLeft:"85px",color:"#4158A6"}}>Direct Users</h3>
